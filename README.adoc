...
. Clone the ./../../src/spring-guides/gs-spring-boot[Spring Boot Getting Started] sample project into the directory you created by typing `git clone ./../../src/spring-guides/gs-spring-boot`
